					      ...
					      struct obs_properties *advanced)
{
	...
	set_tip_on(protection, IRLSAFETY_SET_AUTO_DELAY_SEC, "IRLSAFETYPlus.AutoDelaySec.Tooltip");
	set_tip_on(protection, IRLSAFETY_SET_AUTO_DELAY_HOLD_SEC, "IRLSAFETYPlus.AutoDelayHoldSec.Tooltip");
	set_tip_on(protection, IRLSAFETY_SET_PARTIAL_PII_THRESHOLD, "IRLSAFETYPlus.PartialPiiThreshold.Tooltip");
	set_tip_on(protection, IRLSAFETY_SET_COVER_WHILE_TYPING, "IRLSAFETYPlus.CoverWhileTyping.Tooltip");
	set_tip_on(protection, IRLSAFETY_SET_SECURE_MODE_ENABLE, "IRLSAFETYPlus.SecureModeEnable.Tooltip");
	set_tip_on(protection, IRLSAFETY_SET_SECURE_DROP_FRAMES, "IRLSAFETYPlus.SecureDropFrames.Tooltip");
	set_tip_on(protection, "hybrid_delay_audio_note", "IRLSAFETYPlus.HybridDelayAudioNote.Tooltip");
